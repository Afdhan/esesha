...
echo -e "${cyan}==================================-[ SERVICES STATUS ]-=============================${off}"
echo -e ""
echo -e "${green}Dalam Project Ini, Kami Tidak Bertanggung Jawab Jika Terjadi Kesalahan Pada Saat Anda Merubah Pengaturan System! Baik Itu Tampilan Menu, Banner SSH, Ataupun Yang Lainnya."
echo -e "${off}"
